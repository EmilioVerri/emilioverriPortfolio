...
if($errore!=""){
    ...
    $indirizzo="emilio.verri.13@gmail.com";
    $oggetto = $_POST['oggetto'];
    $contenuto = $_POST['messaggio'];
    $headers = "From: " . $_POST['email'];

    if(mail($indirizzo,$oggetto,$contenuto,$headers)){
        $messaggio="<div class='alert alert-success' role='alert'>Grazie per averci contattati!: ".$messaggio."</div>";
    }
    else{
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header-social-icon">
                                <ul>
                                    <li><a href="https://www.facebook.com/emilio.verri.3152"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="https://www.instagram.com/emilio_verri/"><i class="lni-instagram-original"></i></a></li>
                                    <li><a href="https://github.com/EmilioVerri?tab=repositories"><i class="lni-github-original"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/emilio-verri-911027212/"><i class="lni-linkedin-original"></i></a></li>
                                </ul>
                            </div> <!-- header social -->
                        </div>
                    </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50">
                        <h5 class="about-title">Queste sono le mie conoscienze</h5>
                        <p>
                            Ricordo ancora la prima linea di codice in terza superiore che mi ha portato oggi a diventare un Web Design and Software Developer, è bastato un semplice Hello World!  per  scaturire dentro di me la voglia irrefrenabile di approfondire (imparare) il linguaggio del web. 
                            Concluse le scuole superiori mi sono dunque iscritto ad un percorso di studi ITS per migliorare le mie skills nella scrittura dei codici. 
                            Durante il mio percorso di studi ho perfezionato le mie conoscienza back-end con php e nello sviluppo front-end con html,css,bootstrap e JavaScript. Qua a fianco troverete una mia autovalutazione delle mie conoscienze.</p>
                        <ul class="clearfix">
                            <li>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6">
                    <div class="about-skills pt-25">
                        ...
                        <div class="skill-item mt-25">
                            <div class="skill-header">
                                <h6 class="skill-title">SIMFONY</h6>
                                <div class="skill-percentage">
                                    <div class="count-box counted">
